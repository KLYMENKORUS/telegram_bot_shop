...
<i>Cтоимость:</i> <b>{} uah за 1 ед.</b>

<i>Количество позиций:</i> <b>{} ед.</b> 
"""

no_orders = """
{}, у Вас нет текущего заказа. Выбирите категорию для заказа товара!
"""
...
<i>Общая стоимость заказа составляет:</i> <b>{} uah</b>
...
<b>Через некоторое время с Вами свяжется менеджер для уточнения.
Спасибо за Ваш заказ!!</b>
"""

select_payments = '<b>{}, как Вы желаете оплатить Ваш заказ?</b>'
